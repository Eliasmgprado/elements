import { isHttpOperation, isHttpService, useLayoutConfig, Logo, TableOfContents, PoweredByLink, SidebarLayout, ParsedDocs, HttpMethodColors, DeprecatedBadge, TryItWithRequestSamples, Docs, slugify, withRouter, withStyles, withPersistenceBoundary, withMosaicProvider, withQueryClientProvider, withLayoutConfigProvider, useParsedValue, useBundleRefsIntoDocument, useLayoutConfigStarter, NonIdealState, InlineRefResolverProvider } from '@stoplight/elements-core';
...
const computeAPITree = (serviceNode, config = {}, layoutConfig) => {
    ...
    tree.push({
        id: '/',
        slug: '/',
        title: (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.apiTree) === null || _a === void 0 ? void 0 : _a.overview) !== null && _b !== void 0 ? _b : 'Overview',
        type: 'overview',
        meta: '',
    });
    ...
    if (operationNodes.length) {
        tree.push({
            title: (_d = (_c = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.apiTree) === null || _c === void 0 ? void 0 : _c.endpoints) !== null && _d !== void 0 ? _d : 'Endpoints',
        });
    ...
    if (!mergedConfig.hideSchemas && schemaNodes.length) {
        tree.push({
            title: (_f = (_e = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.apiTree) === null || _e === void 0 ? void 0 : _e.schemas) !== null && _f !== void 0 ? _f : 'Schemas',
        });
...
const APIWithSidebarLayout = ({ serviceNode, logo, hideTryIt, hideSchemas, hideInternal, hideExport, exportProps, tryItCredentialsPolicy, tryItCorsProxy, }) => {
    ...
    const tree = React.useMemo(() => computeAPITree(serviceNode, { hideSchemas, hideInternal }, layoutConfig), [serviceNode, hideSchemas, hideInternal, layoutConfig]);
...
const APIImpl = props => {
    ...
    const { layout, apiDescriptionUrl = '', logo, hideTryIt, hideSchemas, hideInternal, hideExport, tryItCredentialsPolicy, tryItCorsProxy, layoutConfig, } = props;
    ...
    if (error) {
        return (React.createElement(Flex, { justify: "center", alignItems: "center", w: "full", minH: "screen" },
            React.createElement(NonIdealState, { title: (_b = (_a = config === null || config === void 0 ? void 0 : config.api) === null || _a === void 0 ? void 0 : _a.descriptionUrlErrorTitle) !== null && _b !== void 0 ? _b : 'Document could not be loaded', description: (_d = (_c = config === null || config === void 0 ? void 0 : config.api) === null || _c === void 0 ? void 0 : _c.descriptionUrlError) !== null && _d !== void 0 ? _d : 'The API description document could not be fetched. This could indicate connectivity problems, or issues with the server hosting the spec.', icon: "exclamation-triangle" })));
    }
    if (!bundledDocument) {
    ...
    if (!serviceNode) {
        return (React.createElement(Flex, { justify: "center", alignItems: "center", w: "full", minH: "screen" },
            React.createElement(NonIdealState, { title: (_f = (_e = config === null || config === void 0 ? void 0 : config.api) === null || _e === void 0 ? void 0 : _e.descriptionFileErrorTitle) !== null && _f !== void 0 ? _f : 'Failed to parse OpenAPI file', description: (_h = (_g = config === null || config === void 0 ? void 0 : config.api) === null || _g === void 0 ? void 0 : _g.descriptionFileError) !== null && _h !== void 0 ? _h : 'Please make sure your OpenAPI file is valid and try again' })));
    }
...
const API = flow(withRouter, withStyles, withPersistenceBoundary, withMosaicProvider, withQueryClientProvider, withLayoutConfigProvider)(APIImpl);
