...
const LayoutConfigContext = React__default.createContext({
    config: defaultLayoutConfig$1,
    setConfig: () => { },
});
LayoutConfigContext.displayName = 'LayoutConfigContext';
const LayoutConfigProvider = ({ children }) => {
    const [layoutConfig, setLayoutConfig] = React__default.useState(defaultLayoutConfig$1);
    const setLayoutConfigHandler = React__default.useCallback((newConfig) => {
    ...
    return React__default.createElement(LayoutConfigContext.Provider, { value: contextValue }, children);
};
    ...
    return (React__default.createElement(Panel, { rounded: embeddedInMd ? undefined : true, isCollapsible: embeddedInMd },
        React__default.createElement(Panel.Titlebar, { rightComponent: React__default.createElement(CopyButton, { size: "sm", copyValue: requestSample || '' }) },
            React__default.createElement(Box, { ml: -2 },
                React__default.createElement(Menu, { "aria-label": "Request Sample Language", closeOnPress: true, items: menuItems, renderTrigger: ({ isOpen }) => {
                        var _a, _b;
                        return (React__default.createElement(Button, { size: "sm", iconRight: "chevron-down", appearance: "minimal", active: isOpen },
...
const TryItAuth = ({ operationSecurityScheme: operationAuth, onChange, value }) => {
    ...
    return (React.createElement(Panel, { defaultIsOpen: true },
        React.createElement(Panel.Titlebar, { rightComponent: filteredSecurityItems.length > 1 && (React.createElement(Menu, { "aria-label": "security-schemes", items: menuItems, closeOnPress: true, renderTrigger: ({ isOpen }) => (React.createElement(Button, { appearance: "minimal", size: "sm", iconRight: ['fas', 'sort'], active: isOpen }, menuName)) })) }, (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.tryIt) === null || _a === void 0 ? void 0 : _a.authTitle) !== null && _b !== void 0 ? _b : 'Auth'),
        React.createElement(SecuritySchemeComponent, { scheme: value ? value.scheme : filteredSecurityItems[0], onChange: handleChange, value: (_c = (value && value.authValue)) !== null && _c !== void 0 ? _c : '' })));
};
...
const FormDataBody = ({ specification, values, onChangeValues, onChangeParameterAllow, isAllowedEmptyValues, }) => {
    ...
    return (React.createElement(Panel, { defaultIsOpen: true },
        React.createElement(Panel.Titlebar, null, (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.tryIt) === null || _a === void 0 ? void 0 : _a.formDataBodyTitle) !== null && _b !== void 0 ? _b : 'Body'),
...
const RequestBody = ({ examples, requestBody, onChange }) => {
    ...
    const layoutConfig = useLayoutConfig();
    return (React.createElement(Panel, { defaultIsOpen: true },
        React.createElement(Panel.Titlebar, { rightComponent: examples.length > 1 && React.createElement(ExampleMenu, { examples: examples, requestBody: requestBody, onChange: onChange }) }, (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.request) === null || _a === void 0 ? void 0 : _a.bodyHeader) !== null && _b !== void 0 ? _b : 'Body'),
...
const OperationParameters = ({ parameters, values, onChangeValue, validate, }) => {
    ...
    const layoutConfig = useLayoutConfig();
    return (React.createElement(Panel, { defaultIsOpen: true },
        React.createElement(Panel.Titlebar, null, (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.operationParameters) === null || _a === void 0 ? void 0 : _a.title) !== null && _b !== void 0 ? _b : 'Parameters'),
    ...
    const tryItPanelContents = (React.createElement(React.Fragment, null,
        ...
        React.createElement(Panel.Content, { className: "SendButtonHolder", mt: 4, pt: !isOnlySendButton && !embeddedInMd ? 0 : undefined },
            React.createElement(HStack, { alignItems: "center", spacing: 2 },
                React.createElement(Button, { appearance: "primary", loading: loading, disabled: loading, onPress: handleSendRequest, size: "sm" }, (_j = (_h = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.tryIt) === null || _h === void 0 ? void 0 : _h.sendApiRequest) !== null && _j !== void 0 ? _j : 'Send API Request'),
...
const ResponseExamples = ({ httpOperation, responseMediaType, responseStatusCode }) => {
    ...
    return (React__default.createElement(Panel, { rounded: true, isCollapsible: false },
        React__default.createElement(Panel.Titlebar, { rightComponent: React__default.createElement(CopyButton, { size: "sm", copyValue: responseExample || '' }) }, examplesSelect || React__default.createElement(Text, { color: "body" }, (_c = (_b = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.responseExamples) === null || _b === void 0 ? void 0 : _b.title) !== null && _c !== void 0 ? _c : 'Response Example')),
...
const Body = ({ body, onChange }) => {
    ...
    return (React.createElement(VStack, { spacing: 6 },
        React.createElement(SectionSubtitle, { title: (_c = (_b = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.responses) === null || _b === void 0 ? void 0 : _b.bodyHeader) !== null && _c !== void 0 ? _c : 'Body', id: "request-body" }, contents.length > 0 && (React.createElement(Flex, { flex: 1, justify: "end" },
...
const Request = ({ operation: { request, request: { path: pathParams = [], headers: headerParams = [], cookie: cookieParams = [], body, query: queryParams = [], } = {}, security, }, onChange, }) => {
    ...
    return (React.createElement(VStack, { spacing: 8 },
        React.createElement(SectionTitle, { title: (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.request) === null || _a === void 0 ? void 0 : _a.header) !== null && _b !== void 0 ? _b : 'Request' }),
        ...
        pathParams.length > 0 && (React.createElement(VStack, { spacing: 5 },
            React.createElement(SectionSubtitle, { title: (_d = (_c = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.request) === null || _c === void 0 ? void 0 : _c.pathParameters) !== null && _d !== void 0 ? _d : 'Path Parameters' }),
        ...
        queryParams.length > 0 && (React.createElement(VStack, { spacing: 5 },
            React.createElement(SectionSubtitle, { title: (_f = (_e = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.request) === null || _e === void 0 ? void 0 : _e.queryParameters) !== null && _f !== void 0 ? _f : 'Query Parameters' }),
        ...
        headerParams.length > 0 && (React.createElement(VStack, { spacing: 5 },
            React.createElement(SectionSubtitle, { title: (_h = (_g = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.request) === null || _g === void 0 ? void 0 : _g.headerParameters) !== null && _h !== void 0 ? _h : 'Headers', id: "request-headers" }),
        ...
        cookieParams.length > 0 && (React.createElement(VStack, { spacing: 5 },
            React.createElement(SectionSubtitle, { title: (_k = (_j = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.request) === null || _j === void 0 ? void 0 : _j.cookiesParameters) !== null && _k !== void 0 ? _k : 'Cookies', id: "request-cookies" }),
...
const Responses = ({ responses: unsortedResponses, onStatusCodeChange, onMediaTypeChange }) => {
    ...
    return (React.createElement(VStack, { spacing: 8, as: Tabs, selectedId: activeResponseId, onChange: setActiveResponseId, appearance: "pill" },
        React.createElement(SectionTitle, { title: (_d = (_c = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.responses) === null || _c === void 0 ? void 0 : _c.header) !== null && _d !== void 0 ? _d : 'Responses' },
...
const Response = ({ response, onMediaTypeChange }) => {
    ...
    return (React.createElement(VStack, { spacing: 8, pt: 8 },
        ...
        contents.length > 0 && (React.createElement(React.Fragment, null,
            React.createElement(SectionSubtitle, { title: (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.responses) === null || _a === void 0 ? void 0 : _a.bodyHeader) !== null && _b !== void 0 ? _b : 'Body', id: "response-body" },
...
const AdditionalInfo = ({ termsOfService, contact, license }) => {
    ...
    return contactLink || licenseLink || tosLink ? (React__default.createElement(Panel, { rounded: true, isCollapsible: false },
        React__default.createElement(Panel.Titlebar, { bg: "canvas-300" },
            React__default.createElement("span", { role: "heading" }, (_k = (_j = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.additionalInfo) === null || _j === void 0 ? void 0 : _j.title) !== null && _k !== void 0 ? _k : 'Additional Information')),
        React__default.createElement(Panel.Content, { p: 0 },
...
const SecuritySchemes = ({ schemes, defaultScheme, defaultCollapsed = false, }) => {
    ...
    return (React__default.createElement(Panel, { rounded: true, isCollapsible: defaultCollapsed },
        React__default.createElement(Panel.Titlebar, { bg: "canvas-300" },
            React__default.createElement(Box, { as: "span", role: "heading" }, (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.securitySchemes) === null || _a === void 0 ? void 0 : _a.title) !== null && _b !== void 0 ? _b : 'Security')),
...
const ServerInfo = ({ servers, mockUrl }) => {
    ...
    return (React.createElement(InvertTheme, null,
        React.createElement(Panel, { rounded: true, isCollapsible: false, className: "BaseURLContent", w: "full" },
            React.createElement(Panel.Titlebar, { whitespace: "nowrap" }, (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.serverInfo) === null || _a === void 0 ? void 0 : _a.title) !== null && _b !== void 0 ? _b : 'API Base URL'),
...
const ModelExamples = React.memo(({ data, isCollapsible = false }) => {
    ...
    return (React.createElement(Panel, { rounded: true, isCollapsible: isCollapsible, defaultIsOpen: !isCollapsible },
        React.createElement(Panel.Titlebar, { rightComponent: selectedExample ? React.createElement(CopyButton, { size: "sm", copyValue: selectedExample }) : null }, examplesSelect || (React.createElement(Text, { color: "body", role: "heading" }, (_c = (_b = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.modelExamples) === null || _b === void 0 ? void 0 : _b.title) !== null && _c !== void 0 ? _c : 'Example'))),
...
function withLayoutConfigProvider(WrappedComponent) {
    const WithLayoutConfigProvider = (props) => {
        return (React__default.createElement(LayoutConfigProvider, null,
