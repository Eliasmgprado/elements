...
const defaultLayoutConfig$1 = {
    api: {
        descriptionUrlErrorTitle: 'Document could not be loaded',
        descriptionUrlError: 'The API description document could not be fetched. This could indicate connectivity problems, or issues with the server hosting the spec.',
    ...
    badges: {
        ...
        deprecatedTip: 'This operation has been marked as deprecated, which means it could be removed at some point in the future.',
        internal: 'Internal',
        internalTip: isHttpService => `This ${isHttpService ? 'operation' : 'model'} is marked as internal and won't be visible in public docs.`,
    },
    modelExamples: {
        title: 'Example',
    },
...
const defaultLayoutConfig = {
    api: {
        ...
        descriptionUrlError: 'O documento de descrição do API não pôde ser obtido. Isto poderia indicar problemas de conectividade, ou problemas com o servidor que aloja o arquivo.',
    },
    apiTree: {
        overview: 'Sobre',
        endpoints: 'Rotas',
    ...
    badges: {
        ...
        deprecatedTip: 'Esta operação foi marcada como depreciada, o que significa que poderá ser removida em algum momento no futuro.',
        internalTip: isHttpService => ` ${isHttpService ? 'Esta operação' : 'Este modelo'} é marcado como interno e não será visível em documentos públicos.`,
    },
    modelExamples: {
        title: 'Exemplo',
    },
...
const LayoutConfigContext = React__default["default"].createContext({
    config: defaultLayoutConfig$1,
    setConfig: () => { },
});
LayoutConfigContext.displayName = 'LayoutConfigContext';
const LayoutConfigProvider = ({ children }) => {
    const [layoutConfig, setLayoutConfig] = React__default["default"].useState(defaultLayoutConfig$1);
    const setLayoutConfigHandler = React__default["default"].useCallback((newConfig) => {
        if (typeof newConfig === 'string') {
            if (newConfig === 'EN') {
                setLayoutConfig(defaultLayoutConfig$1);
            }
            if (newConfig === 'PT-BR') {
            ...
            setLayoutConfig((previousConfig) => {
                return Object.keys(previousConfig).reduce((obj, key) => {
                    if (newConfig.hasOwnProperty(key)) {
                        obj[key] = Object.assign(Object.assign({}, previousConfig[key]), newConfig[key]);
                    }
                    else {
    ...
    return React__default["default"].createElement(LayoutConfigContext.Provider, { value: contextValue }, children);
};
const useLayoutConfigStarter = (userConfig) => {
    const { config, setConfig } = React.useContext(LayoutConfigContext);
    ...
    return (React__default["default"].createElement(mosaic.Panel, { rounded: embeddedInMd ? undefined : true, isCollapsible: embeddedInMd },
        React__default["default"].createElement(mosaic.Panel.Titlebar, { rightComponent: React__default["default"].createElement(mosaic.CopyButton, { size: "sm", copyValue: requestSample || '' }) },
            React__default["default"].createElement(mosaic.Box, { ml: -2 },
                React__default["default"].createElement(mosaic.Menu, { "aria-label": "Request Sample Language", closeOnPress: true, items: menuItems, renderTrigger: ({ isOpen }) => {
                        var _a, _b;
                        return (React__default["default"].createElement(mosaic.Button, { size: "sm", iconRight: "chevron-down", appearance: "minimal", active: isOpen },
                            `${(_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.requestSamples) === null || _a === void 0 ? void 0 : _a.title) !== null && _b !== void 0 ? _b : 'Request Sample'}: `,
                            selectedLanguage,
                            " ",
...
const FormDataBody = ({ specification, values, onChangeValues, onChangeParameterAllow, isAllowedEmptyValues, }) => {
    ...
    return (React__namespace.createElement(mosaic.Panel, { defaultIsOpen: true },
        React__namespace.createElement(mosaic.Panel.Titlebar, null, (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.tryIt) === null || _a === void 0 ? void 0 : _a.formDataBodyTitle) !== null && _b !== void 0 ? _b : 'Body'),
...
const RequestBody = ({ examples, requestBody, onChange }) => {
    ...
    const layoutConfig = useLayoutConfig();
    return (React__namespace.createElement(mosaic.Panel, { defaultIsOpen: true },
        React__namespace.createElement(mosaic.Panel.Titlebar, { rightComponent: examples.length > 1 && React__namespace.createElement(ExampleMenu, { examples: examples, requestBody: requestBody, onChange: onChange }) }, (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.request) === null || _a === void 0 ? void 0 : _a.bodyHeader) !== null && _b !== void 0 ? _b : 'Body'),
...
const OperationParameters = ({ parameters, values, onChangeValue, validate, }) => {
    ...
    const layoutConfig = useLayoutConfig();
    return (React__namespace.createElement(mosaic.Panel, { defaultIsOpen: true },
        React__namespace.createElement(mosaic.Panel.Titlebar, null, (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.operationParameters) === null || _a === void 0 ? void 0 : _a.title) !== null && _b !== void 0 ? _b : 'Parameters'),
    ...
    const tryItPanelContents = (React__namespace.createElement(React__namespace.Fragment, null,
        ...
        React__namespace.createElement(mosaic.Panel.Content, { className: "SendButtonHolder", mt: 4, pt: !isOnlySendButton && !embeddedInMd ? 0 : undefined },
            React__namespace.createElement(mosaic.HStack, { alignItems: "center", spacing: 2 },
                React__namespace.createElement(mosaic.Button, { appearance: "primary", loading: loading, disabled: loading, onPress: handleSendRequest, size: "sm" }, (_j = (_h = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.tryIt) === null || _h === void 0 ? void 0 : _h.sendApiRequest) !== null && _j !== void 0 ? _j : 'Send API Request'),
...
const ResponseExamples = ({ httpOperation, responseMediaType, responseStatusCode }) => {
    ...
    return (React__default["default"].createElement(mosaic.Panel, { rounded: true, isCollapsible: false },
        React__default["default"].createElement(mosaic.Panel.Titlebar, { rightComponent: React__default["default"].createElement(mosaic.CopyButton, { size: "sm", copyValue: responseExample || '' }) }, examplesSelect || React__default["default"].createElement(mosaic.Text, { color: "body" }, (_c = (_b = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.responseExamples) === null || _b === void 0 ? void 0 : _b.title) !== null && _c !== void 0 ? _c : 'Response Example')),
...
const DeprecatedBadge = () => {
    var _a, _b, _c, _d;
    const layoutConfig = useLayoutConfig();
    return (React__default["default"].createElement(mosaic.Tooltip, { renderTrigger: React__default["default"].createElement(mosaic.Badge, { intent: "warning", icon: ['fas', 'exclamation-circle'], "data-testid": "badge-deprecated" }, (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.badges) === null || _a === void 0 ? void 0 : _a.deprecated) !== null && _b !== void 0 ? _b : 'Deprecated') }, (_d = (_c = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.badges) === null || _c === void 0 ? void 0 : _c.deprecatedTip) !== null && _d !== void 0 ? _d : 'This operation has been marked as deprecated, which means it could be removed at some point in the future.'));
};
const InternalBadge = ({ isHttpService }) => {
    var _a, _b, _c;
    const layoutConfig = useLayoutConfig();
    return (React__default["default"].createElement(mosaic.Tooltip, { renderTrigger: React__default["default"].createElement(mosaic.Badge, { icon: faEye, "data-testid": "badge-internal", bg: "danger" }, (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.badges) === null || _a === void 0 ? void 0 : _a.internal) !== null && _b !== void 0 ? _b : 'Internal') }, ((_c = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.badges) === null || _c === void 0 ? void 0 : _c.internalTip)
...
const Body = ({ body, onChange }) => {
    ...
    return (React__namespace.createElement(mosaic.VStack, { spacing: 6 },
        React__namespace.createElement(SectionSubtitle, { title: (_c = (_b = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.responses) === null || _b === void 0 ? void 0 : _b.bodyHeader) !== null && _c !== void 0 ? _c : 'Body', id: "request-body" }, contents.length > 0 && (React__namespace.createElement(mosaic.Flex, { flex: 1, justify: "end" },
...
const Request = ({ operation: { request, request: { path: pathParams = [], headers: headerParams = [], cookie: cookieParams = [], body, query: queryParams = [], } = {}, security, }, onChange, }) => {
    ...
    return (React__namespace.createElement(mosaic.VStack, { spacing: 8 },
        React__namespace.createElement(SectionTitle, { title: (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.request) === null || _a === void 0 ? void 0 : _a.header) !== null && _b !== void 0 ? _b : 'Request' }),
        ...
        pathParams.length > 0 && (React__namespace.createElement(mosaic.VStack, { spacing: 5 },
            React__namespace.createElement(SectionSubtitle, { title: (_d = (_c = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.request) === null || _c === void 0 ? void 0 : _c.pathParameters) !== null && _d !== void 0 ? _d : 'Path Parameters' }),
        ...
        queryParams.length > 0 && (React__namespace.createElement(mosaic.VStack, { spacing: 5 },
            React__namespace.createElement(SectionSubtitle, { title: (_f = (_e = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.request) === null || _e === void 0 ? void 0 : _e.queryParameters) !== null && _f !== void 0 ? _f : 'Query Parameters' }),
        ...
        headerParams.length > 0 && (React__namespace.createElement(mosaic.VStack, { spacing: 5 },
            React__namespace.createElement(SectionSubtitle, { title: (_h = (_g = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.request) === null || _g === void 0 ? void 0 : _g.headerParameters) !== null && _h !== void 0 ? _h : 'Headers', id: "request-headers" }),
        ...
        cookieParams.length > 0 && (React__namespace.createElement(mosaic.VStack, { spacing: 5 },
            React__namespace.createElement(SectionSubtitle, { title: (_k = (_j = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.request) === null || _j === void 0 ? void 0 : _j.cookiesParameters) !== null && _k !== void 0 ? _k : 'Cookies', id: "request-cookies" }),
...
const SecurityPanel = ({ scheme, includeKey }) => {
    ...
    const layoutConfig = useLayoutConfig();
    return (React__namespace.createElement(SubSectionPanel, { title: `${(_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.securitySchemes) === null || _a === void 0 ? void 0 : _a.title) !== null && _b !== void 0 ? _b : 'Security'}: ${getReadableSecurityName(scheme, includeKey)}`, defaultIsOpen: !!expandedState[scheme.key], onChange: isOpen => setExpanded(Object.assign(Object.assign({}, expandedState), { [scheme.key]: isOpen })) },
...
const Responses = ({ responses: unsortedResponses, onStatusCodeChange, onMediaTypeChange }) => {
    ...
    return (React__namespace.createElement(mosaic.VStack, { spacing: 8, as: mosaic.Tabs, selectedId: activeResponseId, onChange: setActiveResponseId, appearance: "pill" },
        React__namespace.createElement(SectionTitle, { title: (_d = (_c = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.responses) === null || _c === void 0 ? void 0 : _c.header) !== null && _d !== void 0 ? _d : 'Responses' },
...
const Response = ({ response, onMediaTypeChange }) => {
    ...
    return (React__namespace.createElement(mosaic.VStack, { spacing: 8, pt: 8 },
        ...
        contents.length > 0 && (React__namespace.createElement(React__namespace.Fragment, null,
            React__namespace.createElement(SectionSubtitle, { title: (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.responses) === null || _a === void 0 ? void 0 : _a.bodyHeader) !== null && _b !== void 0 ? _b : 'Body', id: "response-body" },
...
const AdditionalInfo = ({ termsOfService, contact, license }) => {
    ...
    const contactLink = (contact === null || contact === void 0 ? void 0 : contact.name) && (contact === null || contact === void 0 ? void 0 : contact.url)
        ? `[${(_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.additionalInfo) === null || _a === void 0 ? void 0 : _a.contact) !== null && _b !== void 0 ? _b : 'Contact'} ${contact.name}](${contact.url})`
        : (contact === null || contact === void 0 ? void 0 : contact.email)
            ? `[${(_d = (_c = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.additionalInfo) === null || _c === void 0 ? void 0 : _c.contact) !== null && _d !== void 0 ? _d : 'Contact'} ${contact.name || contact.email}](mailto:${contact.email})`
            : '';
    ...
    const licenseLink = (license === null || license === void 0 ? void 0 : license.name) && licenseUrl
        ? `[${license.name} ${(_f = (_e = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.additionalInfo) === null || _e === void 0 ? void 0 : _e.license) !== null && _f !== void 0 ? _f : 'License'}](${licenseUrl})`
        : '';
    const tosLink = termsOfService
        ? `[${(_h = (_g = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.additionalInfo) === null || _g === void 0 ? void 0 : _g.termsOfService) !== null && _h !== void 0 ? _h : 'Terms of Service'}](${termsOfService})`
        : '';
    return contactLink || licenseLink || tosLink ? (React__default["default"].createElement(mosaic.Panel, { rounded: true, isCollapsible: false },
        React__default["default"].createElement(mosaic.Panel.Titlebar, { bg: "canvas-300" },
            React__default["default"].createElement("span", { role: "heading" }, (_k = (_j = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.additionalInfo) === null || _j === void 0 ? void 0 : _j.title) !== null && _k !== void 0 ? _k : 'Additional Information')),
        React__default["default"].createElement(mosaic.Panel.Content, { p: 0 },
...
const SecuritySchemes = ({ schemes, defaultScheme, defaultCollapsed = false, }) => {
    ...
    return (React__default["default"].createElement(mosaic.Panel, { rounded: true, isCollapsible: defaultCollapsed },
        React__default["default"].createElement(mosaic.Panel.Titlebar, { bg: "canvas-300" },
            React__default["default"].createElement(mosaic.Box, { as: "span", role: "heading" }, (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.securitySchemes) === null || _a === void 0 ? void 0 : _a.title) !== null && _b !== void 0 ? _b : 'Security')),
...
const ServerInfo = ({ servers, mockUrl }) => {
    ...
    return (React__namespace.createElement(mosaic.InvertTheme, null,
        React__namespace.createElement(mosaic.Panel, { rounded: true, isCollapsible: false, className: "BaseURLContent", w: "full" },
            React__namespace.createElement(mosaic.Panel.Titlebar, { whitespace: "nowrap" }, (_b = (_a = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.serverInfo) === null || _a === void 0 ? void 0 : _a.title) !== null && _b !== void 0 ? _b : 'API Base URL'),
...
const ModelExamples = React__namespace.memo(({ data, isCollapsible = false }) => {
    ...
    return (React__namespace.createElement(mosaic.Panel, { rounded: true, isCollapsible: isCollapsible, defaultIsOpen: !isCollapsible },
        React__namespace.createElement(mosaic.Panel.Titlebar, { rightComponent: selectedExample ? React__namespace.createElement(mosaic.CopyButton, { size: "sm", copyValue: selectedExample }) : null }, examplesSelect || (React__namespace.createElement(mosaic.Text, { color: "body", role: "heading" }, (_c = (_b = layoutConfig === null || layoutConfig === void 0 ? void 0 : layoutConfig.modelExamples) === null || _b === void 0 ? void 0 : _b.title) !== null && _c !== void 0 ? _c : 'Example'))),
...
function withLayoutConfigProvider(WrappedComponent) {
    const WithLayoutConfigProvider = (props) => {
        return (React__default["default"].createElement(LayoutConfigProvider, null,
...
exports.useLayoutConfigStarter = useLayoutConfigStarter;
exports.useParsedData = useParsedData;
exports.useParsedValue = useParsedValue;
exports.useRouter = useRouter;
exports.withLayoutConfigProvider = withLayoutConfigProvider;
